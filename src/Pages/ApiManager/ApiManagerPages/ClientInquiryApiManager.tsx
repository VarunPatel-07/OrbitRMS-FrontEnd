                            ...
                            <div className='p-2.5 space-y-4'>
                              ...
                              <div className='bg-amber-50 border border-amber-200 rounded-lg p-3'>
                                ...
                                <ul className='font-inter text-sm text-amber-900 mt-1 ml-4 list-disc space-y-1'>
                                  ...
                                  <li>
                                    The data type expected for each field
                              ...
                              <div className='border-l-4 border-red-500 bg-red-50 p-3 rounded-r-lg'>
                                <p className='font-inter text-sm text-red-900'>
                                  ...
                                  data types of the submitted values must
                                  strictly match the types defined in the config
                                  module's form field (e.g., string, number,
                                  array).
                                </p>
                              </div>
  ...
  "message": "I'm interested in your services."
                              ...
                              <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                                <p className='font-inter text-sm text-blue-900'>
                                  ...
                                  and that your API key, secret, and form ID are
                                  kept confidential. If your credentials are
                                  invalid or missing, the API will respond with
