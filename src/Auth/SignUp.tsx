...
const initialOrganizationFormInfo = {
  organizationName: "",
  primaryEmail: "",
  defaultPortalUrlSlug: "orbitrms.com",
  websiteUrl: "",
  contactNumber: "",
};
...
function SignIn() {
  ...
  const handleFormSubmit = (e: React.MouseEvent<HTMLButtonElement>) => {
    console.log(currentPage, formData);
    if (currentPage == 1) {
      e.preventDefault();
          ...
          <div className="w-full h-full flex items-stretch justify-start relative">
            ...
            <div className="rounded-none w-full md:w-2/3 bg-white md:rounded-l-[24px] lg:rounded-l-[40px]  z-10">
              <div className="login-form w-full h-full  z-20 flex items-center justify-center">
                <div className="flex flex-col gap-8 sm:gap-10 items-start justify-start w-full max-w-[440px] p-4 md:p-0">
                  <div className="w-full px-5 flex flex-col gap-6 items-start transition-all">
                    {currentPage == 2 && (
                      <button
                        className="font-medium text-[var(--them-orange-color)] cursor-pointer text-sm transition-all"
                  ...
                  <div className="w-full overflow-hidden">
                    <div
                      ...
                      <div className="grid grid-cols-1 gap-y-5  w-full min-w-full px-5">
                      ...
                      <div className="flex flex-col gap-y-5 justify-between w-full min-w-full px-5">
                        <div className="w-full">
                          <Input
                            name="websiteUrl"
                            ref={defaultInputRef}
                            ...
                            onChange={(e) => handelInputFieldChange(e)}
                            showError={showError && formData?.websiteUrl?.trim() === ""}
                            errorMessage="This field is required."
                          />
                        </div>
                        <div className="w-full">
