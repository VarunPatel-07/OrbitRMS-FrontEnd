...
import { RichTextEditorApiResponseInterface } from '@/interface/ComponentProps.interface';
import {
   AddEditPostFormdataInterface,
   cloudSignDataInterface,
   FeedPostDataPropsInterface,
} from '@/interface/Dashboard.interface';
import { CloudinaryUploadResult } from '@/interface/Global.interface';
import { OrganizationHolidays } from '@/interface/OrganizationSettings.interface';
import DashboardPlayground from '@/modules/dashboard//DashboardPlayground';
...
import { generateTimeBasedGreeting } from '@/utils/helpers/commonHelpers';
                     ...
                     <p className='text-base text-wrap text-black font-inter font-semibold flex items-center justify-start gap-1'>
                        ...
                        <span>
                           {GlobalStateProvider?.user?.personal_info?.full_name
                              ? GlobalStateProvider?.user?.personal_info
                                   ?.full_name
                              : GlobalStateProvider?.user?.personal_info
                                   ?.first_name +
                                ' ' +
