...
import LikesCommentModal from '@/modules/dashboard//LikesCommentModal';
import {
  FeedPostDataPropsInterface,
  OrganizationFeedPropsInterface,
} from '@/interface/Dashboard.interface';

import EmptyFeedAnimation from '@/components/animations/EmptyFeedAnimation';
import FeedPostCard from '@/components/FeedPostCard';
import FeedPostSkeleton from '@/components/loaders/FeedPostSkeleton';
