...
function ClientInquiryApiManager() {
   ...
   const handelClickOnCopyButton = () => {
      const metaUrl = `${BACKEND_API_BASEURL}/public/v1/inquiries/submit?api_key=YOUR_API_KEY&api_secret=YOUR_API_SECRET&form_id=YOUR_FORM_ID`;
                                       ...
                                       <div className='border border-black/10 rounded-lg w-full'>
                                          ...
                                          <div className='p-2.5 space-y-4'>
                                             <p className='font-inter text-sm text-black/70'>
                                                To submit a new client inquiry,
                                                make a{' '}
                                                <span className='font-semibold'>
                                                   POST
                                                </span>{' '}
                                                request to the following
                                                endpoint. You must include a
                                                valid{' '}
                                             ...
                                             <div className='bg-amber-50 border border-amber-200 rounded-lg p-3'>
                                                <p className='font-inter text-sm text-amber-900'>
                                                   ...
                                                   the form to which you are
                                                   submitting the inquiry. This
                                                   ensures your submission is
                                                   routed to the correct form
                                                   configuration.
                                                </p>
                                                <p className='font-inter text-sm text-amber-900 mt-2'>
                                                   ...
                                                   . You will see all the forms
                                                   for your organization. You
                                                   can retrieve the{' '}
                                                   <code className='bg-amber-200/50 px-1.5 py-0.5 rounded font-semibold'>
                                                      form_id
                                                   </code>{' '}
                                                   from there. Note that you can
                                                   edit the form details, but
                                                   the{' '}
                                                   <span className='font-semibold'>
                                                      Form ID
                                                   </span>{' '}
                                                ...
                                                <p className='font-inter text-sm text-amber-900 mt-2'>
                                                   ...
                                                   The form_id is used to
                                                   retrieve the complete schema
                                                   of all fields for that
                                                   specific form. This schema
                                             ...
                                             <div className='border-l-4 border-red-500 bg-red-50 p-3 rounded-r-lg'>
                                                <p className='font-inter text-sm text-red-900'>
                                                   ...
                                                   Additionally, the data types
                                                   of the submitted values must
                                                   strictly match the types
                                                   defined in the config
                                                   module's form field (e.g.,
                                                   string, number, array).
                                                </p>
                                             </div>
  ...
  "message": "I'm interested in your services."
                                             ...
                                             <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                                                <p className='font-inter text-sm text-blue-900'>
                                                   ...
                                                   fields are provided and that
                                                   your API key, secret, and
                                                   form ID are kept
                                                   confidential. If your
                                                   credentials are invalid or
                                                   missing, the API will respond
