...
import { SocialMedialPostComponentInterface } from '@/interface/SocialMedia.interface';
import SocialMediaPostCard from '@/modules/socialMedia/SocialMediaModuleHelper/SocialMediaPostCard';

import Button from '@/components/common/Button';
import SocialMediaPostLoader from '@/components/loaders/SocialMediaPostLoader';
...
function SocialMediaPosts(props: SocialMedialPostComponentInterface) {
  ...
  return (
    <div className='w-full h-full rounded-lg flex flex-col'>
      ...
      {loading ? (
        <SocialMediaPostLoader length={6} />
      ) : (
        <>
