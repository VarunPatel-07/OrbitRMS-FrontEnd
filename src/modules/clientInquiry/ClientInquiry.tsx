...
import { handelGeneratingDynamicClientColumn } from '@/modules/clientInquiry/ClientInquiryHelper';
...
function ClientInquiry() {
               ...
               return (
                  <div className='w-full h-full flex items-center justify-start gap-2'>
                     ...
                     <Button
                        ...
                        disabled={permissionData?.permissions?.some(
                           (item) =>
                              item?.label == 'delete' && !item?.is_allowed
                        )}
                     >
   ...
   const fetchAllClientInquiryWithDebounce = useDebounce(
      async (
         ...
         try {
            ...
            const formId =
               form_id || filter_form_id || selectedInquiryForm?.formId;
            const endPointArr: endpointObject[] = [
               {
                  endPoint:
   ...
   const handelApplyFilterClientInquiry = async (
      ...
      setTimeout(() => {
         navigate(
            `/${organization}/client-inquiry?${queryString}&${formQuery}`
         );
      }, 0);
                  ...
                  {isInitialFetching ? (
                     ...
                     <>
                        <TableInfoHeader
                           ...
                           buttonsArray={[]}
                           renderElement={InquiryFormsSearchDrop(
                              inquiryFormData
                           )}
                        />
                           ...
                           <>
                              <TableFilterSearchBar
                                 ...
                                 handelApplyFilterFunc={
                                    handelApplyFilterClientInquiry
                                 }
                                 ...
                                 <>
                                    ...
                                    <TablePagination
                                       ...
                                       handelClickOnDroDownVal={
                                          handelClickOnRecordPerPage
                                       }
                                       clickOnPaginationVal={
                                          handelClickOnPaginationButtons
                                       }
