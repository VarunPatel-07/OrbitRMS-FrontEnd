               ...
               <div className='flex flex-col items-center justify-center gap-6'>
                  <div className='w-full'>
                     <div className='w-full'>
                        <Input
                           ...
                           showError={
                              showError || urlSafetyStatus.urlStatus != 'safe'
                           }
                           errorMessage={
                              websiteUrl.length == 0
                                 ? showError
                  ...
                  <div className='w-full'>
                        ...
                        {websiteUrl ? (
                           metaTag ? (
                              ...
                              <p className='text-black text-base font-semibold text-center'>
                                 Ready to verify? Click below to generate your
                                 meta tag!
                              </p>
                           ) : (
                              <p className='text-black text-base font-semibold text-center'>
                                 Enter A Valid URL Formate to generate Meta Tag
                                 and confirm Your ownership.
                              </p>
                           )
                        ) : (
                           <p className='text-black text-base font-semibold text-center'>
                              No meta tag yet! Enter your website URL to
                              generate one and confirm ownership.
                           </p>
                        )}
                        {metaTag ? (
                           <button
                     ...
                     <p className='text-black/60 text-sm font-medium text-start pt-2.5'>
                        ...
                        Place your generated meta tag on all pages of your
                        website. If you're using a CMS, check its documentation
                        to apply it globally. Once added, click "Verify" to
                  ...
                  <div className='w-full flex flex-col gap-3'>
                     <button
                        ...
                        onClick={
                           metaTag ? handleVerifyMetaTag : handleGenerateMetaTag
                        }
                        disabled={
                           loading || urlSafetyStatus.urlStatus != 'safe'
                        }
                     >
                        {metaTag ? (
                           loading ? (
