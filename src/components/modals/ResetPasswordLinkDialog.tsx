...
import { isValidEmail } from '@/utils/helpers/commonHelpers';

import DialogModalContainer from '../common/DialogModalContainer';

const ResetPasswordLinkDialog = ({
  isOpen,
  setIsOpen,
  handelSubmit,
  companyEmail,
  personalEmail,
}: ResetPasswordLinkModalInterface) => {
      ...
      <div className='p-6 space-y-4 '>
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-sm text-amber-700'>
                This action will remove access from all logged-in devices. The
                user must create a new password and log in again to regain
                access.
              </p>
            </div>
          </div>
        ...
        >
          <>
            ...
            <div className='flex-1 text-left'>
              <p className='font-semibold text-gray-800'>Personal Email</p>
...
export default ResetPasswordLinkDialog;
