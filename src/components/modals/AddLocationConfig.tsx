...
function AddLocationConfig({
  ...
  const [formData, setFromData] = useState<OrgLocationConfigDataArrayInterface>(
    LOCATION_CONFIG_INITIAL
  );
  ...
  return (
    <DialogModalContainer
      ...
      loading={loading}
      maxWidth='600px'
      modalTitle={locationData ? 'Edit Location Config' : 'Add Location Config'}
    >
      <div className='w-full'>
        ...
        >
          ...
          <div className='w-full bg-black/[0.03] rounded-lg px-4 py-3 flex items-center justify-between'>
            <div>
              <p className='text-sm font-medium text-black'>Location config</p>
          ...
          <div>
            ...
            {!formData?.location_coordinates && error?.location_coordinates && (
        ...
        <div className='px-5 pb-5 w-full grid grid-cols-2 gap-2.5'>
          ...
          >
            {loading ? (
              <Loader loaderText={locationData ? 'Adding...' : 'Updating...'} />
            ) : locationData ? (
