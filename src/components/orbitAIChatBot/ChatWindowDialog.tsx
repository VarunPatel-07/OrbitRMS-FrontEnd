...
function ChatWindowDialog(props: ChatWindowModalInterface) {
                    ...
                    <div key={index} className='flex justify-start'>
                      <div className='bg-white border border-gray-200 px-5 py-4 rounded-2xl max-w-[85%] shadow-sm'>
                        ...
                        <button
                          ...
                          onClick={() => OnSuccessButtonClick(data?.content)}
                        >
                          Use This
                        </button>
                      </div>
        ...
        >
          <div className='flex items-center justify-center flex-col gap-4 px-6'>
            <div className='relative'>
              <Image
                src={OrbitAiIcon}
                className={classNames('w-32 h-32 object-cover drop-shadow-lg', {
            ...
            {loading ? (
              <p className='text-gray-600 font-medium text-lg'>Thinking...</p>
            ) : (
        ...
        <div
          className={classNames(
            'w-full flex items-end bg-gray-50 rounded-xl overflow-hidden transition-all relative border-2',
            {
              ...
              'border-gray-200 focus-within:border-indigo-400': !showError,
            }
          )}
        >
          <textarea
...
export default ChatWindowDialog;
