...
import { MultipleImageUploaderPropsInterface } from '@/interface/ComponentProps.interface';
import { SelectedFileArrayObjInterface } from '@/interface/Global.interface';
import { v4 as uuidv4 } from 'uuid';

import MultipleImageCropper from '@/components/common/dragDropUploader/MultipleFileUploader/MultipleImageCropper';
