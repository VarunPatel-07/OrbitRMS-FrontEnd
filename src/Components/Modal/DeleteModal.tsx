  ...
  return (
    ...
    >
      <div className='w-full h-full flex items-center justify-center'>
        <div
          className={classNames(
            `delete-modal bg-white min-h-[${minHeight || 300}px] min-w-[600px] transition-all px-8 rounded-lg relative overflow-hidden flex flex-col items-start justify-end`,
            {
