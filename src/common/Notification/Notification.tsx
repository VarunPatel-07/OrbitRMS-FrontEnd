  ...
  return (
    <>
      {directionArray.map((direction) => (
        <div
          key={direction}
          className={classNames("w-fit h-auto max-h-screen overflow-auto absolute z-30 bg-transparent", {
              ...
              .map((notification: NotificationObject) => (
                <div
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-black">{notification.message || "This Is A Test Notification"}</p>
                  </div>
                </div>
              ))}
          </div>
