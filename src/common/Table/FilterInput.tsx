...
function FilterInput({
  ...
  clientInquiryFilters: clientInquiryFiltersInterFace[];
}) {
  ...
  const handelClick = (id: string, filter: clientInquiryFiltersInterFace) => {
    ...
    updateFilterObject({
      label: filter.label as unknown as string,
      value: filter.id,
    });
  };
        ...
        <div className='flex items-start justify-start gap-2'>
          ...
          <div
            className={classNames(
              'shadow-xl rounded-md overflow-hidden origin-top transition-all',
              {
          ...
          <div
            className={classNames(
              'shadow-xl rounded-md overflow-hidden origin-top transition-all left-10 relative',
              {
